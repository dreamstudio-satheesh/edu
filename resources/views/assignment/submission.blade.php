                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" data-field="student_name">
                                        {{ __('student_name') }}</th>
                                    <th scope="col" data-field="text" data-formatter="textFormatter">{{ __('text') }} {{ __('submission') }}</th>
                    ...
                    <div class="modal-content">
                        ...
                        <form class="pt-3 class-edit-form" id="edit-form" action="{{ url('assignment-submission') }}"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label>{{ __('text') }} {{ __('submission') }}</label>
                                    {!! Form::textarea('text', null, ['class' => 'form-control', 'id' => 'text', 'disabled' => 'disabled']) !!}
                                </div>
